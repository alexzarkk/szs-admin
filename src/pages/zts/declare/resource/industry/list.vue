				...
				<div class="user">
					<cl-crud ref="crud" @load="onCrudLoad" boder>
						<el-row type="flex">
							...
							<cl-filter label="等级">
								<el-select size="mini" v-model="queryParams.level" @change="refresh()">
									<el-option :value="0" label="全部"></el-option>
									<el-option :value="1" label="核心资源"></el-option>
									<el-option :value="2" label="重要资源"></el-option>
									<el-option :value="3" label="一般资源"></el-option>
									<el-option :value="4" label="兴趣点"></el-option>
									<el-option :value="5" label="服务设施"></el-option>
								</el-select>
							</cl-filter>
							<cl-search-key />
						</el-row>
