<template>
	<cl-crud ref="crud" @load="onCrudLoad" boder>
		<el-row type="flex">
			...
			<cl-refresh-btn />
			<el-button v-permission="$service.zts.kml.permission.merge" type="warning" :disabled="selected.length!=2" size="mini" @click="merge">合并</el-button>
			<el-button v-permission="$service.zts.kml.permission.move" size="mini" type="success" :disabled="selected.length != 1" @click="toMove()">转移</el-button>
			...
			<el-button :loading="epxorting" size="mini" type="success" @click="exportExcel">导出</el-button>
			<cl-flex1 />
			<cl-filter label="等级">
