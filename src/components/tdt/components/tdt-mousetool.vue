	...
	data() {
		return {
			...
			events: {
				...
				polygonTool: [{ origin: 'draw', new: 'polygon-draw' }, { origin: 'addpoint', new: 'polygon-addpoint' }],
				polylineTool: [{ origin: 'draw', new: 'polyline-draw' }, { origin: 'addpoint', new: 'polyline-addpoint' }],
				rectangleTool: [{ origin: 'draw', new: 'rectangle-draw' }],
				circleTool: [{ origin: 'draw', new: 'circle-draw' }, { origin: 'drawend', new: 'circle-drawend' }]
			}
		};
	},
	methods: {
