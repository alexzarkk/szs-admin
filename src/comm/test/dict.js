...
const laySt = [
    ...
    { label: '验收退回', value: 32, type: 'danger' },
    { label: '安装', value: 40, type: 'warning' },
    { label: '验收', value: 50, type: 'sucssce' }
];
...
const poi = {
    ...
    4: [
        { text: '旅游度假区', value: 4010 },
        { text: '主题公园', value: 4012 },
        { text: '城市公园', value: 4014 },
        { text: '农业观光园', value: 4020 },
